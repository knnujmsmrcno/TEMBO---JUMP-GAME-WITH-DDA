...
// Load sound files
const jumpSound = new Audio('SOUNDS_FX/jumpSound.mp3');
const coinSound = new Audio('SOUNDS_FX/coinSound.mp3');
const backgroundMusic = new Audio('SOUNDS_FX/backgroundMusic.mp3');
const introMusic = new Audio('SOUNDS_FX/intro.mp3');
...
function loadAssets(callback) {
  backgroundImage.src = 'BACKGROUNDS/gamebackground2.png';
  backgroundImage.onload = function () {
    ...
    characterImage1.onload = function () {
      ...
      characterImage2.onload = function () {
        floorImage.src = 'BACKGROUNDS/lavafloor.png'; // Replace with the path to your floor tile image
        floorImage.onload = function () {
          explosionImage.src = 'BACKGROUNDS/T-fireexplosion.png'; // Replace with the path to your explosion image
...
// Show the play button at the start of the game
...
playButton.addEventListener('click', function() {
  ...
  canvas.classList.remove("blurred"); // Remove blur when game starts
});
...
function detectPlatformCollision() {
  ...
  function update() {
    if (!gameOver) {
      ...
      // Call adjustDifficulty to change platform behavior based on the score
      adjustDifficulty(player, platforms);
    }
...
function gameLoop() {
  adjustDifficulty(player, platforms);
  updatePlayerPosition(player, platforms);
  update();
  render();
